...
import { FaPhone, FaEnvelope, FaMapMarkerAlt, FaUserEdit } from "react-icons/fa";
  ...
  const renderProfile = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
        ...
        <InfoItem icon={<FaPhone />} label="Phone" value={
          userData.other_info?.phone || userData.other_info?.guardian_phone || userData.other_info?.contact_number || userData.phone
        } />
        <InfoItem icon={<FaMapMarkerAlt />} label="Address" value={userData.other_info?.address} />
        <InfoItem icon={<FaUserEdit />} label="Relationship with the child" value={
          userData.guardian_info?.relationship || userData.relationship || userData.other_info?.relationship || 'Not provided'
        } />
      </div>
    </div>
  );
